...
function createCities(cb) {
    async.series([
        function(callback) {
          cityCreate('London', 'England', 'Europe', 704,'London is one of the most diverse cities on the planet. There are great museums, theatre and galleries, as well as some of the best shopping in the world.
...
The nightlife is active throughout the city. During the warmer months it’s common to see a lot more people up late walking through the downtown neighbourhoods. Paris is not dangerous, but you must have the same care as in any big city. 

Paris was one of the world centres for jazz. Often in the summer months free outdoor concerts are performed.',3,400, callback);
        },
        ],
        // optional callback
        cb);
